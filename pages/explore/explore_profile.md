...
Placeholder text: to describe Provenance is contained resource in Flag, Condition, Consent resources (and shows in the Extension section diagrams for them).
...
Placeholder text: to describe Organization contained within PractitionerRole-1
...
Placeholder text: to describe Practitioner contained within PractitionerRole-1
...
<div id="ImageAsset"><img src="images/resourceImages/PractitionerRoleResource.png" style="width:350px;"></div>
<div id="ImageAsset"><img src="images/resourceImages/PractitionerRoleExtensions.png" style="width:350px;"></div>
